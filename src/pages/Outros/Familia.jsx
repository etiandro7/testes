...
export default function Familia({ onFechar = () => {}, id = 'modal' })
{
...
const eventoclicar = (e) => {
    ...
    return(
      ...
      <div className="h-auto w-1/2 bg-white opacity-100">
           <h1 className={` relative bg-blue-900 h-10 py-3 font-extrabold pl-1 shadow-inner text-gray-50`}>REGISTO DE FAMÍLIA DELETIVA
           <span
           ...
           <hr />
           <Entrada label="Família Deletiva"
           valor={Familia}
