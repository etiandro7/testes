...
export default function Pds() {
    ...
    const [Tipopessoa, setTipopessoa] = useState('PDS')
        ...
        <div className={`container mx-auto shadow-md flex flex-col w-1/2`}>
            <div className="w-full shadow-md">
                <h1 className={`bg-blue-900 h-10 py-3 font-extrabold pl-5 shadow-inner text-gray-50`}>
                    REGISTO DE POTENCIAL DELETIVO</h1>
                <hr />
                ...
                <div className={`flex flex-row w-full justify-end items-end `}>
                    ...
                    <div className={`flex relative flex-row flex-wrap m-7  w-40  bg-gray-50 shadow-xl rounded-lg h-40  border-2 border-black border-dashed`}>
                       ...
                       {!fotosel?(
                        ...
                        <Image src={foto} className={`w-full h-full  bg-green-100 shadow-md rounded-lg`} alt=""/>
                       </>)}
