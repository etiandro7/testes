        ...
        return (
            <tr>
                 <td className=" text-center font-black">Nº</td>
                    ...
                    <td className=" whitespace-nowrap font-light">Nº de Motor</td>

                    
                    <td className="pl-2 whitespace-nowrap font-light">Motivo Apreensão</td>
                    <td className="pl-2 whitespace-nowrap font-light">Agente</td>
                    <td className="pl-2 whitespace-nowrap font-light">Dia</td>
                    <td className="pl-2 whitespace-nowrap font-light">Mês</td>
