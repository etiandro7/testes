...
const ULogado = Usuario_Logado()
    ...
    const [ListarViatura, setListarViatura] = useState([])
    ...
    useEffect(()=>{
        fetch(`http://localhost:3000/api/Outros/Viatura`)
        .then(res =>res.json())
        .then(setListarViatura)
       },[tipoviatura]) 
    ...
    return (
     ...
     focus:outline-none 
      font-extralight bg-white w-full py-1 p-2
                ...
                <div className={`flex flex-col col-span-1 mr-2 mx-2`}>
                            <label className={`text-gray-700 font-semibold uppercase`}>Estado da {tipoviatura}</label>
     ...
     focus:outline-none 
      font-extralight bg-white w-full py-1 p-2
                           max-h-10 uppercase`}>
                            ...
                            <option value="Viatura">BOM </option>
                            <option value="Motorizada">AVARIADO</option>
                            <option value="Motorizada">NOVO</option>
                            <option value="Motorizada">REGULAR</option>
                        </select>
                    </div>
